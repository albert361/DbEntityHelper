...
namespace SMBCTPE.Helper
{
    ...
    public class ToolStripHelper
    {
            ...
            else
            {
                ...
                switch (template)
                {
                    case Template.Approve:
                        item.Image = global::SMBCTPE.Properties.Resources.icoOk;
                        item.Name = "tlsbtnApprove";
                        item.Text = "&Approve";
                        break;
                    case Template.Calendar:
                        item.Image = global::SMBCTPE.Properties.Resources.icoCalendar;
                        item.Name = "tlsbtnCalendar";
                        item.Text = "&Calendar";
                        break;
                    case Template.Clear:
                        item.Image = global::SMBCTPE.Properties.Resources.icoErase;
                        item.Name = "tlsbtnClear";
                        item.Text = "&Clear";
                        break;
                    case Template.Copy:
                        item.Image = global::SMBCTPE.Properties.Resources.icoCopy;
                        item.Name = "tlsbtnCopy";
                        item.Text = "&Copy";
                        break;
                    case Template.Delete:
                        item.Image = global::SMBCTPE.Properties.Resources.icoTrash;
                        item.Name = "tlsbtnDelete";
                        item.Text = "&Delete";
                        break;
                    case Template.Download:
                        item.Image = global::SMBCTPE.Properties.Resources.icoDownload;
                        item.Name = "tlsbtnDownload";
                        item.Text = "&Download";
                        break;
                    case Template.Exit:
                        item.Image = global::SMBCTPE.Properties.Resources.icoLogout;
                        item.Name = "tlsbtnExit";
                        item.Text = "&Exit";
                        break;
                    case Template.Export:
                        item.Image = global::SMBCTPE.Properties.Resources.icoExport;
                        item.Name = "tlsbtnExport";
                        item.Text = "&Export";
                        break;
                    case Template.Inquire:
                        item.Image = global::SMBCTPE.Properties.Resources.isoSearch;
                        item.Name = "tlsbtnInquire";
                        item.Text = "&Inquire";
                        break;
                    case Template.Link:
                        item.Image = global::SMBCTPE.Properties.Resources.icoLink;
                        item.Name = "tlsbtnLink";
                        item.Text = "&Link";
                        break;
                    case Template.Modify:
                        item.Image = global::SMBCTPE.Properties.Resources.icoEdit;
                        item.Name = "tlsbtnModify";
                        item.Text = "&Modify";
                        break;
                    case Template.New:
                        item.Image = global::SMBCTPE.Properties.Resources.icoNew;
                        item.Name = "tlsbtnNew";
                        item.Text = "&New";
                        break;
                    case Template.Print:
                        item.Image = global::SMBCTPE.Properties.Resources.icoPrinter;
                        item.Name = "tlsbtnPrint";
                        item.Text = "&Print";
                        break;
                    case Template.Reject:
                        item.Image = global::SMBCTPE.Properties.Resources.icoCancel;
                        item.Name = "tlsbtnReject";
                        item.Text = "&Reject";
                        break;
                    case Template.Send:
                        item.Image = global::SMBCTPE.Properties.Resources.icoSend;
                        item.Name = "tlsbtnSend";
                        item.Text = "&Send";
                        break;
                    case Template.Settings:
                        item.Image = global::SMBCTPE.Properties.Resources.icoSettings;
        ...
        /// <para>
        /// <seealso cref="SMBCTPE.Global.BaseForm.Permission"/>
        /// </para>
        /// </param>
